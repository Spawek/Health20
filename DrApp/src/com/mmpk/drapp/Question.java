...
import android.app.Activity;
	public class Question implements IState{
		...
		IState GetNextQuestion(boolean answer)
		{
			if(answer)
				return yesPtr;
			else
		...
		{
			return new QuestionActivity(title, question, new QuestionController(this)); //TODO: generate activity using this object data
		}
